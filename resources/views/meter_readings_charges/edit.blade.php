  ...
  <div class="container">
    <div class="features-header">
      <div class="section-label reveal">
          <a href="{{ route('meter-readings-and-charges.index') }}">
              <i class="fa-solid fa-chevron-left"></i>
          </a>
      </div>
      <div class="section-label reveal">Modify <em>Gas Meter Reading</em></div>
      <div class="section-label reveal">
          <a href="{{ route('meter-readings-and-charges.create') }}">
              <i class="fa-solid fa-plus"></i>
          </a>
      </div>
      <div class="section-sub reveal reveal-delay-1">
        
          <form action="{{ route('meter-readings-and-charges.update', $meterReading->id) }}" method="POST">
              @csrf
              @method('PUT')
              ...
              <div class="d-flex justify-content-end gap-2">
                  <a href="{{ route('meter-readings-and-charges.index') }}" class="btn-cta-ghost">Discard Changes</a>
