    ...
    <div class="container" style="max-width: 860px;">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end gap-3 mb-4">
            <div>
                ...
                <p class="text-muted mb-0">
                    Enter each bill total for the month. On generate it splits equally among flats that have that bill type enabled
        ...
        @foreach($bills as $bill)
            @php
                ...
                $formSuffix = $type->key;
                $usesMeterReadings = $type->usesMeterReadings();
            @endphp
            <div class="bg-white border rounded-3 shadow-sm p-4 mb-4">
                <div class="d-flex justify-content-between align-items-start gap-2 mb-3">
                    <div>
                        ...
                        <div class="text-muted small">
                            @if($usesMeterReadings)
                                Equal split · optional meter readings · omit flats via bill type settings
                            @else
                                Plain monthly bill · equal split · omit flats via bill type settings
                            @endif
                        </div>
                    </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <div class="fw-bold fs-5">{{ $selectedMonth->format('F Y') }}</div>
                    </div>
                    <div class="col-md-4">
                ...
                <form method="post" action="{{ route('admin.water.store') }}">
                    ...
                    <div class="row g-3">
                        <div class="{{ $usesMeterReadings ? 'col-md-6' : 'col-md-6' }}">
                        ...
                        <div class="col-md-6">
                            <div class="text-muted small mb-1">Saved total</div>
                            <div class="fw-bold fs-4 pt-1">
